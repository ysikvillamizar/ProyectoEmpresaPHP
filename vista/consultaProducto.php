...
try{
 ...
 switch ($bot) {
  case "Modificar":
    ...
    $proveedor=$objProducto->getIdProv();
    ...
    if(($estado=$objProducto->getEstado())==0){
      ...
      try{
        ...
        if($image){
            ...
            $objProducto= new Producto($cod,$proveedor,$nom,$ruta,$estado);
            $objControlProducto= new ControlProducto($objProducto);
        ...
        $objProducto= new Producto($cod,$proveedor,$nom,$imagen,$estado);
        $objControlProducto= new ControlProducto($objProducto);
        $objProducto=$objControlProducto->modificar();
...
case "Eliminar":
  ...
  $objProducto=$objControlProducto->consultar();
    ...
    if(($estado=$objProducto->getEstado())==1){
      echo "<script>alert('¿Está seguro que desea inactivar el producto?');
      </script>";

      $dia=date("yy-m-d");
      $objProducto= new Producto($cod,$idProv,$nom,$imagen,$estado);
            $objControlProducto= new ControlProducto($objProducto);
            $objProducto=$objControlProducto->modificar();
...
<html lang=\"en\">
  ...
  <body>
        <form method=\"post\" action=\"consultaProducto.php\" enctype=\"multipart/form-data\">
     <!-- sesion titulo -->       
    <section id=\"cover\"> 
     <div id=cover-texto>
     <div class=\"container\">
    ...
    <div class=\"modal-dialog text-center\">
      <div class=\"col-sm-12 main-section\">
        <div id=\"usuario\" class=\"modal-content\">
            ...
            <div id=\"texto\">Código:</div>
            <div id=\"form\"> 
                    <input   type=\"text\" name=\"txtCodigo\" placeholder=\"código\" class=\"form-control\" id=\"idTxtCodigo\" value='".$cod."' required=\"\"/>
            </div>
            </div>
                    ...
                    <div id=\"form\"> 
                          ...
                          <input  type=\"text\" name=\"txtNombre\" placeholder=\"nombre \" id=\"idTxtNombre\" class=\"form-control\" value='".$nom."' />
                    </div>
                    </div>
                    ...
                    <div class=\"form-group \" id=\"user-group\">
                    <label id=\"texto\" class=\"text-left\">Proveedor:</label>
                    <div id=\"form\"> 
					
                          <input  type=\"text\" name=\"txtNomProv\" readonly=»readonly»  placeholder=\"proveedor \" class=\"form-control\" value='".$idProv."' />
                    </div>
                    </div>
