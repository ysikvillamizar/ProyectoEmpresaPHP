...
try{
 ...
 switch ($bot) {
    ...
    case "Guardar":
      ...
      $objUsuario= new Usuario($usuario,$contrasena,4);
...
<html lang=\"en\">
  ...
  <body>
        <form method=\"post\" action=\"vistaProveedor.php\" enctype=\"multipart/form-data\">
     <!-- sesion titulo -->       
    <section id=\"cover\"> 
     <div id=cover-texto>
     <div class=\"container\">
      ...
      <div class=\"col-sm-12 main-section\">
        <div class=\"modal-content\">
             ...
             <form class=\"col-12\">
                    ...
                    <div id=\"form\"> 
                            <input type=\"text\" name=\"txtTipoProveedor\" placeholder=\"tipo proveedor\" class=\"form-control\"  value='".$tipo."' required=\"\"/>
                    </div>
                   </div>
              <div class=\"form-group\" id=\"user-group\">
            ...
            <input  type=\"file\" name=\"txtImagen\" class=\"form-control\" value='".$image."' accept=\"image/*\">
                  ...
                  <div class=\"bn-group btn-group-justified\">
                   ...
                   <!--  <a type=\"submit\" href=\"vistaProducto.php\" name=\"btn\" class=\"btn btn-primary\" value=\"Producto\">Producto</a>--> 
                  </br>
