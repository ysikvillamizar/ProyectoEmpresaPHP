...
try{
 ...
 switch ($bot) {
	...
	try{
		...
		$type=$_FILES['txtHojaVida']['type'];
		$tmp_name = $_FILES['txtHojaVida']["tmp_name"];
		$name = $_FILES['txtHojaVida']["name"];
        ...
        $objEmpleado= new Empleado($ced,$nom,$fechaIng,$fechaRet,$salBas,$ded,$foto,$hojaV,$email,$tel,$cel);
...
<html lang=\"en\">
  ...
  <body>
        <form method=\"post\" action=\"vistaEmpleado.php\">
     <!-- sesion titulo -->       
    <section id=\"cover\"> 
     <div id=cover-texto>
     <div class=\"container\">
        ...
        <ul class=\"navbar-nav mr-auto\">
          ...
          <li class=\"nav-item dropdown\">
            ...
            <div class=\"dropdown-menu\" aria-labelledby=\"navbarDropdown\">
              ...
              <a class=\"dropdown-item\" href=\"menu.php\">Administrador</a>
            </div>
          </li>
          <li class=\"nav-item\">
